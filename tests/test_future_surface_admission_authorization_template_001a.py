...
REQUIRED_ABLATIONS = {
    "ablate_manifest_dependency_list",
    "ablate_dependency_verdicts",
    "ablate_template_hash",
    "ablate_manifest_hash",
    "ablate_validator_readback_reference",
    "ablate_trace_reference",
    "ablate_code_path_hash",
    "ablate_claim_ceiling_field",
    "ablate_banned_scope_field",
    "ablate_old_invalid_surface_exclusion_field",
