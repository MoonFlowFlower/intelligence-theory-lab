...
- Task id: `ACTION-CONDITIONED-SELF-BOUNDARY-PREFLIGHT-001A`
...
- Claim ceiling: Bounded no-candidate evidence about whether a clean action-conditioned self-boundary / controllability surface is admissible for future candidate testing. This does not prove mechanism success, Gate4/Gate5 validity, candidate behavior, tournament outcome, bridge/runtime/EGO readiness, agency, autonomy, consciousness, emotion, subjectivity, companion readiness, stable user benefit, or any mechanism_score claim.
...
- Best independent baseline: `{'baseline_id': 'majority_baseline', 'score': 0.25, 'threshold': 0.55}`
- Legal oracle minus best independent baseline: `0.75`
- Invoked baselines: `['majority_baseline', 'observation_only_classifier', 'action_only_classifier', 'exact_legal_tuple_lookup_with_majority_fallback', 'nearest_neighbor_legal_observation', 'transition_table_action_to_outcome', 'graph_lookup_state_action_outcome', 'successor_map', 'count_table', 'fsm_planner', 'episodic_traversal', 'context_key_arithmetic_probe', 'target_label_leakage_probe']`
- Missing baselines: `[]`
- Transition graph family blocked: `True`
- Context-key arithmetic probe blocked: `True`

## Ablation

- No-action accuracy: `0.0`
- Randomized-action accuracy: `0.0`
- Action-label-shuffle accuracy: `0.0`
- Counterfactual-pair-break accuracy: `0.25`
- Observation-only accuracy: `0.25`
...
Bounded no-candidate evidence about whether a clean action-conditioned self-boundary / controllability surface is admissible for future candidate testing. This does not prove mechanism success, Gate4/Gate5 validity, candidate behavior, tournament outcome, bridge/runtime/EGO readiness, agency, autonomy, consciousness, emotion, subjectivity, companion readiness, stable user benefit, or any mechanism_score claim.
...
If independent review accepts this no-candidate surface preflight, draft a separate bounded candidate task card; otherwise preserve refusal/invalid-harness evidence and close or redesign outside the closed CTSR route.
