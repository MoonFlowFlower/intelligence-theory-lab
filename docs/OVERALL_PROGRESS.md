...
```text
task = RESEARCH-CAMPAIGN-PHASE2C-CANDIDATE-FREE-BASELINE-STRESS-EXECUTION-001A
verdict = phase2c_candidate_free_baseline_stress_audited_success_post_result_route_check_next
...
enabled_status = local_phase2c_candidate_free_baseline_stress_wrapper_executed_and_audited_success
real_trigger_evidence = CLI run of phase2c_candidate_free_baseline_stress_001a.runner generated result, baseline, leakage, replay, ablation, provenance, failure-manifest, and trace artifacts; 5 seeds, 3 train families, 3 heldout families, 4 episodes per family, 120 trace rows, strongest fair baseline episodic_traversal macro accuracy 0.2833333333333333, and graph_cache lookup-family tie preserved as cheap-baseline blocker
claim_ceiling = Candidate-free Phase2C baseline-stress execution evidence only; no candidate validation, no mechanism validity, no learning/adaptation success, subjectivity, consciousness, real-emotion, autonomy, EGO-readiness, companion-readiness, mainline-effect, route-exhaustion, terminal-verdict, candidate-validation, or program-completion claim
...
phase2c_harness_implementation_freeze_task_card_reviewer_audit_status = success_reached
...
phase2c_harness_implementation_freeze_task_card_audit = artifacts/research_campaign/phase2c_harness_implementation_freeze_task_card_audit_001a.json
phase2c_harness_implementation_authorized_scope = future_implementation_under_frozen_paths_only
phase2c_hidden_latent_harness_implementation_status = passed_after_validator_path_predicate_repair
phase2c_hidden_latent_harness_implementation_validation_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_implementation_validation_001a.json
phase2c_hidden_latent_harness_source_path = src/phase2c_hidden_latent_harness_001a/
...
phase2c_hidden_latent_harness_execution_run = true
phase2c_hidden_latent_harness_output_generated = true
phase2c_hidden_latent_harness_valid_execution_evidence = false
phase2c_hidden_latent_harness_execution_validation_status = invalid_execution_output_claim_ceiling_trace_empty
phase2c_hidden_latent_harness_execution_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_001a.json
...
phase2c_hidden_latent_harness_execution_output_repair_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_output_repair_001a.json
phase2c_hidden_latent_harness_execution_output_repair_status = candidate_free_harness_execution_output_repair_validated_pending_reviewer_audit
phase2c_hidden_latent_harness_repaired_trace_row_count = 12
phase2c_hidden_latent_harness_repaired_result_verdict = candidate_free_harness_executed_valid_evidence_path
...
phase2c_hidden_latent_post_result_route_check_task_card = docs/research_campaign/phase2c_hidden_latent_post_result_route_check_task_card_001a.md
phase2c_hidden_latent_post_result_route_check_task_card_validation_artifact = artifacts/research_campaign/phase2c_hidden_latent_post_result_route_check_task_card_validation_001a.json
phase2c_hidden_latent_post_result_route_check_task_card_validation_status = passed
phase2c_hidden_latent_post_result_route_check_artifact = artifacts/research_campaign/phase2c_hidden_latent_post_result_route_check_001a.json
phase2c_hidden_latent_post_result_route_check_audit_artifact = artifacts/research_campaign/phase2c_hidden_latent_post_result_route_check_audit_001a.json
phase2c_hidden_latent_post_result_route_check_reviewer_audit_status = success_reached
phase2c_hidden_latent_post_result_selected_route = candidate_free_baseline_stress_task_card
phase2c_hidden_latent_post_result_route_check_trace_row_count = 12
phase2c_hidden_latent_post_result_route_check_strongest_fair_baseline_id = fsm_planner
phase2c_hidden_latent_post_result_route_check_strongest_fair_baseline_macro_accuracy = 0.3333333333333333
phase2c_hidden_latent_post_result_route_check_random_ties_strongest = true
...
phase2c_candidate_free_baseline_stress_execution_task_card = docs/research_campaign/phase2c_candidate_free_baseline_stress_execution_task_card_001a.md
phase2c_candidate_free_baseline_stress_execution_task_card_validation_artifact = artifacts/research_campaign/phase2c_candidate_free_baseline_stress_execution_task_card_validation_001a.json
phase2c_candidate_free_baseline_stress_execution_task_card_validation_status = passed
phase2c_candidate_free_baseline_stress_execution_run = true
phase2c_candidate_free_baseline_stress_output_generated = true
phase2c_candidate_free_baseline_stress_output_dir = artifacts/phase2c_candidate_free_baseline_stress_001a/
phase2c_candidate_free_baseline_stress_summary_artifact = artifacts/research_campaign/phase2c_candidate_free_baseline_stress_001a.json
phase2c_candidate_free_baseline_stress_audit_artifact = artifacts/research_campaign/phase2c_candidate_free_baseline_stress_audit_001a.json
phase2c_candidate_free_baseline_stress_reviewer_audit_status = success_reached
phase2c_candidate_free_baseline_stress_result_verdict = candidate_work_blocked_by_cheap_baseline_tie
phase2c_candidate_free_baseline_stress_trace_row_count = 120
phase2c_candidate_free_baseline_stress_seed_count = 5
phase2c_candidate_free_baseline_stress_strongest_fair_baseline_id = episodic_traversal
phase2c_candidate_free_baseline_stress_strongest_fair_baseline_macro_accuracy = 0.2833333333333333
phase2c_candidate_free_baseline_stress_baseline_ids_tying_strongest = episodic_traversal, graph_cache, observation_only
phase2c_candidate_free_baseline_stress_lookup_family_ids_tying_strongest = graph_cache
phase2c_candidate_free_baseline_stress_random_ties_strongest = false
phase2c_candidate_free_baseline_stress_replay_passed = true
phase2c_candidate_free_baseline_stress_leakage_positive_controls_passed = true
phase2c_candidate_free_baseline_stress_ablation_all_controls_consumed = true
phase2c_candidate_free_baseline_stress_provenance_check_passed = true
...
phase2c_hidden_latent_harness_execution_command_failure_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_command_failure_001a.json
phase2c_hidden_latent_harness_execution_command_repair_validation_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_command_repair_validation_001a.json
phase2c_hidden_latent_harness_execution_task_card = docs/research_campaign/phase2c_hidden_latent_harness_execution_task_card_001a.md
phase2c_hidden_latent_harness_execution_task_card_validation_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_task_card_validation_001a.json
phase2c_hidden_latent_harness_execution_task_card_validation_status = passed
phase2c_hidden_latent_harness_execution_task_card_reviewer_audit_status = success_reached
phase2c_hidden_latent_harness_execution_task_card_audit_artifact = artifacts/research_campaign/phase2c_hidden_latent_harness_execution_task_card_audit_001a.json
...
current_route_decision_candidate_free_baseline_stress_execution_authorized = true
future_phase2c_candidate_free_baseline_stress_execution_authorized_after_card_review = consumed_by_execution_001a
current_route_decision_post_result_route_check_authorized = true
...
CMBC-COMPANION-PARAMETRIC-ACTION-INTERFACE-005-SHADOW-IMPLEMENT verdict = parametric_shadow_n7_compatibility_pass.
CMBC parametric action interface 005 shadow execution_scope = n7_shadow_compatibility_only.
CMBC parametric action interface 005 shadow candidate_option_count = 7.
CMBC parametric action interface 005 shadow n_gte_20_executed = false.
CMBC parametric action interface 005 shadow old_replay_match_rate = 1.0.
CMBC parametric action interface 005 shadow parametric_replay_match_rate = 1.0.
CMBC parametric action interface 005 shadow selected_action_mismatch_count = 0.
CMBC parametric action interface 005 shadow max_probability_abs_delta = 0.0.
CMBC parametric action interface 005 shadow max_distribution_kl = 0.0.
CMBC parametric action interface 005 shadow semantic_leak_scan_passed = true.
CMBC parametric action interface 005 shadow renderer_runs_after_selection = true.
...
CMBC-COMPANION-CANDIDATE-OPTION-GENERATION-007-SHADOW verdict = candidate_option_generation_shadow_bounded_pass.
CMBC candidate option generation 007 shadow execution_scope = bounded_shadow_implementation_only.
CMBC candidate option generation 007 shadow generated_option_count = 24.
CMBC candidate option generation 007 shadow admitted_option_count = 24.
CMBC candidate option generation 007 shadow generator_selected_action = false.
CMBC candidate option generation 007 shadow semantic_label_visible_to_selector = false.
CMBC candidate option generation 007 shadow natural_language_description_visible_to_selector = false.
CMBC candidate option generation 007 shadow option_lineage_coverage_rate = 1.0.
CMBC candidate option generation 007 shadow option_replay_match_rate = 1.0.
CMBC candidate option generation 007 shadow generator_baseline_action_match_rate = 0.0.
CMBC candidate option generation 007 shadow rag_causal_probe_match_rate = 0.0.
CMBC candidate option generation 007 shadow strong_heuristic_causal_probe_match_rate = 0.0.
CMBC candidate option generation 007 shadow expanded_action_nearest_neighbor_match_rate = 0.0.
CMBC candidate option generation 007 shadow renderer_action_change_rate = 0.0.
...
CMBC-COMPANION-CANDIDATE-OPTION-GENERATION-007-RCA verdict = outcome_update_ordering_bug_confirmed.
CMBC candidate option generation 007 RCA secondary_findings = [feedback_admission_not_applied_to_generated_options, weak_evidence_high_confidence_confirmed, replay_trace_insufficient_for_generated_feedback_admission, selector_scoring_not_primary_blocker].
CMBC candidate option generation 007 RCA failed selected option = generated_option_08_of_24 -> generated_option_04_of_24.
CMBC candidate option generation 007 RCA pending counterevidence selector-visible effect delta = interruption_risk +0.08, trust_delta -0.02.
CMBC candidate option generation 007 RCA changed option confidence = 0.736 -> 0.736.
CMBC candidate option generation 007 RCA same option-id set before/after = true.
CMBC candidate option generation 007 RCA near_duplicate_new_option_bypass_detected = false.
CMBC candidate option generation 007 RCA context_scope_missing_for_feedback_admission = true.
CMBC candidate option generation 007 RCA trace_sufficient_for_generated_feedback_admission = false.
CMBC candidate option generation 007 RCA claim_after_rca = bounded generated CandidateOption execution remains failed; failure localized to pending feedback admission/update ordering.
CMBC-COMPANION-GENERATED-OPTION-FEEDBACK-ADMISSION-007B-CONTRACT verdict = generated_option_feedback_admission_007b_contract_ready.
CMBC generated option feedback admission 007B authorized_scope = contract_only.
CMBC generated option feedback admission 007B execution_authorized = false.
CMBC generated option feedback admission 007B implementation_authorized = false.
CMBC generated option feedback admission 007B source_rca_verdict = outcome_update_ordering_bug_confirmed.
CMBC generated option feedback admission 007B pending_counterevidence selector_visible_effect_update_allowed = false.
CMBC generated option feedback admission 007B requires admission-filtered effect vector.
CMBC generated option feedback admission 007B requires context_scope explicit and traceable.
CMBC generated option feedback admission 007B requires behavior-only replay and admission-aware replay.
...
CMBC-COMPANION-CANDIDATE-OPTION-GENERATION-007-REDTEAM-CONTRACT verdict = generated_option_007_redteam_contract_ready.
CMBC candidate option generation 007 redteam contract authorized_scope = contract_only.
CMBC candidate option generation 007 redteam contract execution_authorized = false.
CMBC candidate option generation 007 redteam contract implementation_authorized = false.
CMBC candidate option generation 007 redteam contract source_verdict = candidate_option_generation_007_reexecute_with_007b_bounded_pass.
CMBC candidate option generation 007 redteam contract required families = fixed_recipe_generator_detection, generator_hidden_selector_detection, admission_always_pass_or_reject_audit, weak_evidence_high_confidence_audit, semantic_label_description_leak_scan, lineage_falsification_missing_source_audit, option_dedup_near_duplicate_bypass_audit, rag_hidden_shortcut_baseline, expanded_nearest_neighbor_frequency_recency_baselines, replay_sufficiency_generated_option_perturbation, deletion_outcome_perturbation_lineage, renderer_adversarial_isolation.
CMBC candidate option generation 007 redteam contract redteam_case_count_minimum = 36.
CMBC candidate option generation 007 redteam contract future redteam_family_coverage_rate = 1.0.
CMBC candidate option generation 007 redteam contract future fixed_recipe_detected = false.
CMBC candidate option generation 007 redteam contract future generator_selected_action = false.
CMBC candidate option generation 007 redteam contract future generator_ranked_final_actions = false.
CMBC candidate option generation 007 redteam contract future generator_recommendation_visible_to_selector = false.
CMBC candidate option generation 007 redteam contract future admission_always_pass_detected = false.
CMBC candidate option generation 007 redteam contract future admission_always_reject_detected = false.
CMBC candidate option generation 007 redteam contract future weak_evidence_high_confidence_rate = 0.0.
CMBC candidate option generation 007 redteam contract future semantic_label_visible_to_selector = false.
CMBC candidate option generation 007 redteam contract future natural_language_description_visible_to_selector = false.
CMBC candidate option generation 007 redteam contract future near_duplicate_bypass_rate = 0.0.
CMBC candidate option generation 007 redteam contract future lineage_coverage_rate = 1.0.
CMBC candidate option generation 007 redteam contract future falsified_lineage_detected = true.
CMBC candidate option generation 007 redteam contract future rag_hidden_shortcut_match_rate < 0.5.
CMBC candidate option generation 007 redteam contract future expanded_nearest_neighbor_match_rate < 0.5.
CMBC candidate option generation 007 redteam contract future frequency_baseline_match_rate < 0.5.
CMBC candidate option generation 007 redteam contract future recency_baseline_match_rate < 0.5.
CMBC candidate option generation 007 redteam contract future behavior_only_replay_match_rate = 1.0.
CMBC candidate option generation 007 redteam contract future admission_aware_replay_match_rate = 1.0.
CMBC candidate option generation 007 redteam contract future renderer_action_change_rate = 0.0.
