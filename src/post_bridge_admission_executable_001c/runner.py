...
def _verify_tag_anchors(repo_root: Path) -> dict[str, Any]:
    ...
    for tag, expected in core.PARENT_REMOTE_ANCHORS.items():
        ...
        try:
            resolved = _git_output(repo_root, ["rev-parse", tag])
            actual[tag] = resolved
...
def _execution_manifest(repo_root: Path, stage0_hash: str, stage0: dict[str, Any]) -> dict[str, Any]:
    source_paths = [
        ...
        core.CONTRACT_PATH,
        core.AGENTS_PATH,
        "src/post_bridge_admission_executable_001c/__init__.py",
        "src/post_bridge_admission_executable_001c/__main__.py",
        "src/post_bridge_admission_executable_001c/core.py",
        "src/post_bridge_admission_executable_001c/runner.py",
...
def _blocked_result(stage0: dict[str, Any], reason: str) -> dict[str, Any]:
    ...
    return {
        ...
        "anti_sycophancy_audit": {
            ...
            "tests_mechanism_or_behavioral_resemblance": "blocked before bounded 001C evidence",
        },
    ...
    *,
    ...
    rows = [
        _metric_row(
            ...
            producer_module="post_bridge_admission_executable_001c.core",
...
def run_admission_001c(
    ...
    *,
    ...
    leakage_report, leakage_invocations = core.run_leakage_scanners(
        episodes,
        trace_rows,
        snapshots,
        provenance_rows,
