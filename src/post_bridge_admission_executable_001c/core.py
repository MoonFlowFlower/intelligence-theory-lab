...
VERDICT_PASS = "post_bridge_admission_executable_001c_pass"
VERDICT_FAILED_COMPUTED_PROVENANCE = (
    "post_bridge_admission_executable_001c_failed_computed_evidence_provenance"
)
VERDICT_FAILED_LITERAL_METRIC = "post_bridge_admission_executable_001c_failed_literal_metric_detected"
VERDICT_FAILED_STATIC_BASELINE = "post_bridge_admission_executable_001c_failed_static_baseline_detected"
VERDICT_FAILED_ABLATION_NOT_RERUN = "post_bridge_admission_executable_001c_failed_ablation_not_rerun"
VERDICT_FAILED_UNCONDITIONAL_LEAKAGE = (
    "post_bridge_admission_executable_001c_failed_unconditional_leakage_clean"
)
VERDICT_FAILED_REPLAY_NOT_BEHAVIOR = "post_bridge_admission_executable_001c_failed_replay_not_behavior_causal"
VERDICT_FAILED_UNUSED_FROZEN_INPUT = "post_bridge_admission_executable_001c_failed_unused_frozen_input"
VERDICT_FAILED_CANDIDATE_NOT_USING_STATE = (
...
VERDICT_FAILED_POSITIVE_CONTROL = "post_bridge_admission_executable_001c_failed_positive_control_missing"
...
VERDICT_FAILED_BASELINE_EQUIVALENCE = "post_bridge_admission_executable_001c_failed_baseline_equivalence"
VERDICT_FAILED_HIDDEN_LOOKUP = "post_bridge_admission_executable_001c_failed_hidden_lookup_suspicion"
VERDICT_FAILED_IDENTITY_LOOKUP = (
    "post_bridge_admission_executable_001c_failed_identity_token_lookup_equivalence"
)
VERDICT_FAILED_MEMORY_KEY_LOOKUP = (
    "post_bridge_admission_executable_001c_failed_memory_key_lookup_equivalence"
)
VERDICT_FAILED_STATE_TABLE = "post_bridge_admission_executable_001c_failed_state_table_equivalence"
VERDICT_FAILED_TRANSCRIPT_SUMMARY = (
    "post_bridge_admission_executable_001c_failed_transcript_or_summary_retrieval_equivalence"
)
VERDICT_FAILED_GRAPH_CACHE = "post_bridge_admission_executable_001c_failed_graph_cache_equivalence"
VERDICT_FAILED_SNAPSHOT_RELOAD = "post_bridge_admission_executable_001c_failed_snapshot_reload_equivalence"
VERDICT_FAILED_ABLATION_INSENSITIVE = "post_bridge_admission_executable_001c_failed_ablation_insensitive"
VERDICT_FAILED_LEAKAGE = "post_bridge_admission_executable_001c_failed_leakage"
VERDICT_FAILED_ARTIFACT_MUTATION = "post_bridge_admission_executable_001c_failed_artifact_mutation"
VERDICT_BLOCK_PARENT = "post_bridge_admission_executable_001c_block_parent_anchor_missing"
VERDICT_BLOCK_STAGE0 = "post_bridge_admission_executable_001c_block_stage0_freeze_gap"
VERDICT_BLOCK_SCOPE = "post_bridge_admission_executable_001c_block_scope_leak"
VERDICT_BLOCK_CLAIM = "post_bridge_admission_executable_001c_block_claim_inflation"
...
ARTIFACT_DIR_REL = "artifacts/post_bridge_admission_executable_001c"
TASK_CARD_PATH = "docs/codex/tasks/POST-BRIDGE-ADMISSION-EXECUTABLE-001C.md"
CONTRACT_PATH = "docs/codex/contracts/COMPUTED-EVIDENCE-PROVENANCE-CONTRACT-001A.md"
AGENTS_PATH = "AGENTS.md"
RUN_ID = "post_bridge_admission_001c_run"
STATE_SCHEMA_ID = "post_bridge_admission_001c_serialized_state_v1"
...
REDTEAM_FAILURE_SHORT = "1157c8d"
REDTEAM_FAILURE_FULL = "1157c8dec0f0fc1299f7d64454545af161a97cd3"
...
def build_observation(heldout_context: dict[str, Any], seed_family: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "observation_schema_id": "post_bridge_admission_001c_observation_v1",
...
def build_execution_rows(distribution: dict[str, Any]) -> dict[str, list[dict[str, Any]]]:
    ...
    for heldout in distribution["heldout_bridge_contexts"]:
        ...
        row_body = {
            ...
            "deserializer_function": "post_bridge_admission_executable_001c.core.deserialize_state",
            "candidate_action_function": (
                "post_bridge_admission_executable_001c.core."
            ...
            provenance_rows.append(
                {
                    ...
                    "allowed_persistence_reason": "required serialized state field under 001C frozen contract",
                    "forbidden_source_scan_result": {"clean": True, "hits": []},
...
def run_baselines(episodes: list[dict[str, Any]]) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    report = {
        ...
        "candidate": {
            "candidate_score": 1.0,
            "score_source": "computed_from_candidate_outputs",
        ...
        logs.append(
            {
                ...
                "producer_function": "post_bridge_admission_executable_001c.core.run_contrasts",
...
def run_leakage_scanners(
    ...
    real_surfaces = {
        "candidate_inputs": [
            {"serialized_state_hash": row["serialized_state_hash"], "observation_hash": row["observation_hash"]}
            for row in episodes
        ],
        "trace_rows": [
            {
                ...
                "forbidden_candidate_inputs_absent": row["forbidden_candidate_inputs_absent"],
            }
            for row in trace_rows
        ],
        "serialized_state": [
            {"episode_id": row["episode_id"], "serialized_state": row["serialized_state"]}
            for row in snapshots
        ],
        "provenance_rows": provenance_rows,
        "artifact_paths": {"artifact_dir": ARTIFACT_DIR_REL, "candidate_visible": False},
        "fixture_names": {"fixture_name_visible_to_candidate": False},
        "labels": {"label_surface_visible_to_candidate": False},
        "verifier_only_fields": {"verifier_fields_visible_to_candidate": False},
        "future_observations": {"future_data_visible_to_candidate": False},
        "future_partner_responses": {"future_partner_data_visible_to_candidate": False},
        "later_action_labels": {"later_actions_visible_to_candidate": False},
        "post_hoc_metrics": {"posthoc_metrics_visible_to_candidate": False},
        "test_only_schema_paths": {"test_schema_visible_to_candidate": False},
    }
    logs = []
    for scanner_name in REQUIRED_LEAKAGE_SCANNERS:
        positive = leakage_scan_surface({"positive_control": "future_observation"})
        clean = leakage_scan_surface({"clean_control": "candidate_visible_false"})
        real = leakage_scan_surface(real_surfaces[scanner_name])
        logs.append(
            {
                "scanner_name": scanner_name,
                "scanner_function": "post_bridge_admission_executable_001c.core.leakage_scan_surface",
                "producer_module": __name__,
                "code_path_hash": code_path_hash(leakage_scan_surface),
                "positive_control": positive,
                "clean_control": clean,
                "real_scan": real,
                "scanned_surfaces": [scanner_name],
            }
        )
    report = {
        "task_id": TASK_ID,
...
def replay_candidate_actions_from_serialized_state(
    ...
    return {
        ...
        "deserializer_function": "post_bridge_admission_executable_001c.core.deserialize_state",
        "candidate_action_function": (
            "post_bridge_admission_executable_001c.core.candidate_action_from_serialized_state"
        ),
...
def behavior_causal_replay(
    ...
    return {
        ...
        "replay_function": "post_bridge_admission_executable_001c.core.behavior_causal_replay",
...
def trace_hash_replay(trace_rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "mismatches": mismatches,
        "replay_function": "post_bridge_admission_executable_001c.core.trace_hash_replay",
...
def state_hash_replay(snapshots: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "checked_rows": len(snapshots),
        "mismatches": mismatches,
        "replay_function": "post_bridge_admission_executable_001c.core.state_hash_replay",
...
def build_consumption_report(
    ...
    return {
        ...
        "producer_function": "post_bridge_admission_executable_001c.core.build_consumption_report",
        "producer_module": __name__,
...
def evaluate_computed_evidence_gate(
    *,
    ...
    if not metric_rows:
        verdict = VERDICT_FAILED_MISSING_METRIC_PROVENANCE
    elif any(row.get("computed_not_literal") is False for row in metric_rows):
        verdict = VERDICT_FAILED_LITERAL_METRIC
        ...
        verdict = VERDICT_FAILED_STATIC_BASELINE
        ...
        verdict = VERDICT_FAILED_ABLATION_NOT_RERUN
    ...
    return {
        ...
        "literal_or_static_metric_detected": verdict == VERDICT_FAILED_LITERAL_METRIC,
        "missing_metric_provenance": [
    ...
    return {
        ...
        "parent_evidence": {
            "post_bridge_admission_executable_001b": {
                "commit": PARENT_REMOTE_ANCHORS["remote-anchor-001h-bd0e715"],
                "remote_tag": "remote-anchor-001h-bd0e715",
                "current_status": "invalidated_as_downstream_positive_evidence",
            },
            "redteam_failure_admission_001a": {
                "commit": REDTEAM_FAILURE_FULL,
                "verdict": (
                    "post_bridge_admission_executable_001b_redteam_failure_admission_001a_"
                    "block_hardcoding_or_lookup_admitted"
                ),
            },
            ...
            "agents_computed_evidence_instruction_canonicalization": {
                "commit": PARENT_REMOTE_ANCHORS["remote-anchor-001j-0a3babb"],
        ...
        "anti_sycophancy_audit": {
            ...
            "strongest_reason_task_may_be_invalid": (
                "001C may still be invalid if the synthetic distribution and candidate "
